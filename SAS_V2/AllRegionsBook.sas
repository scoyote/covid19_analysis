...
/* special report */
/* proc sql; select distinct cbsa_title from cbsa_trajectories where cbsa_title contains "NC"; quit; */

%let overallplotdays=40;
...
/* National */
	%plotNationTrajectory(sortkey=Confirmed,sortdir=descending,maxplots=30,stplot=Y,minconf=1,mindeath=1,xvalues=(10000 to 1310000 by 100000),yvalues=(1000 to 101000 by 20000));
	%plotNationTrajectory(sortkey=dif,maxplots=30,stplot=Y,minconf=100,mindeath=1,xvalues=(100 1000 to 20000 by 2000 20000 to 300000 by 20000),yvalues=(1 500 1000 5000 10000 to 40000 by 10000));
...
/* States */ 	
	...
	%plotUSTrajectory(sortkey=dif,maxplots=30,stplot=Y,minconf=5000,mindeath=100,xvalues=(1000 to 111000 by 10000),	yvalues=(100 to 4800 by 1000));
...
/* CBSAs */		
	...
	%plotCBSATrajectory(sortkey=dif,maxplots=30,stplot=Y,numback=30, minconf=10,mindeath=1,xvalues=(100 1000 10000 to 100000 by 10000), yvalues=(1 10 100 1000 to 10000 by 1000));	

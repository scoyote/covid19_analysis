...
%macro colorramp(
   n=,               /* Number of colors                            */
   start=99293D,     /* Starting color                              */
   mid=FF8000,             /* Middle color                                */
   end=4DBF81,       /* End color                                   */
...
%colorramp(n=30,display=Y,result=mycols,out=covid.colors); 
data covid.colors; set covid.colors;
	keep colornum color;
run;

...
/* States */
%plotUSStates(maxplots=20);
/*  CBSAs  */
%plotCBSAs(maxplots=20);
...
/* run; */
/*  */
/* proc datasets lib=work nodetails nolist; delete _plots _fipsranks; quit; */
/*  */
...
/*  */
/* proc datasets library=work  nodetails nolist; delete _plots _cbsaranks; quit; */
/*  */
/* ****************************************************************** */
...
/*  */
/*  */
/* proc datasets library=work  nodetails nolist; delete _globalplot; quit; */

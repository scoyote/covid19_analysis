...
%CreateModelData(FIPS,FIPS,%str(13135),startdate=01feb20,enddate=&rundate,back=&back);

/* https://web.stanford.edu/~jhj1/teachingdocs/Jones-Epidemics050308.pdf */

proc sql noprint; select distinct combined_key into :titlestring from _mdldata; quit;
...
ods graphics on / reset=all width=10in height=7in imagemap outputfmt=svg imagefmt=svg;

ods html5  body="SEIRModel.htm" (url=none) options(svg_mode="inline");
